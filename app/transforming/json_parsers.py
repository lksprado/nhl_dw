...
from app.transforming.generic_json_parsers import parsing_json_pandas,parsing_json_pandas_2
import glob
...
def raw_season_info():
    output ='data/csv_data/raw/single'
    input_file = 'data/api_data/raw_season_info.json'
...
# def raw_seasons():
#     input_file = 'data/api_data/raw_seasons.json'
#     parsing_json_pandas(input_file,None,output,['season_id'])
