...
renames as (
    ...
    CASE WHEN LOWER("powerPlayNetPct") = 'nan' THEN NULL ELSE CAST("powerPlayNetPct" AS float) END AS powerplay_net_pctg,
    CASE WHEN LOWER("powerPlayPct") = 'nan' THEN NULL ELSE CAST("powerPlayPct" AS float) END AS powerplay_pctg,
